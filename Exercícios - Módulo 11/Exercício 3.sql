...
SELECT CONCAT(FirstName, ' ', LastName) as 'Nome Completo', EmailAddress as 'E-mail',left(EmailAddress, charindex('@', EmailAddress)) as 'Login', concat(Upper(FirstName), day(BirthDate)) as 'Senha' from DimEmployee